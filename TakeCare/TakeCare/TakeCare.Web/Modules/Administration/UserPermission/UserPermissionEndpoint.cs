using MyRepository = TakeCare.Administration.Repositories.UserPermissionRepository;
using MyRow = TakeCare.Administration.UserPermissionRow;

namespace TakeCare.Administration.Endpoints;
